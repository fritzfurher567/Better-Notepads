...
Notepad Standard
-----------------
A feature-complete clone of the classic Windows Notepad, built with
Python/Tkinter, with a modern dark UI.
...
class Notepad:
    def __init__(self, root):
        ...
        # ---- Status bar ----
        self.status = tk.Label(self.root, text="Ln 1, Col 1", anchor="e",
                                bg=STATUS_BG, fg=STATUS_FG, font=("Segoe UI", 9),
                                padx=10, pady=3)
    ...
    def build_menu(self):
        ...
        format_menu = self._menu(menubar)
        ...
        zoom_menu = self._menu(view_menu)
    ...
    def find_next(self):
        ...
        self.text.tag_config("found", background=FOUND_BG, foreground="#ffffff")
    ...
    def open_replace(self):
        ...
        win.configure(bg=BG)
        tk.Label(win, text="Find what:", bg=BG, fg=FG).grid(row=0, column=0, padx=5, pady=5, sticky="e")
        find_e = tk.Entry(win, width=28, bg=MENU_BG, fg=FG, insertbackground=FG, relief="flat")
        find_e.grid(row=0, column=1, padx=5, pady=5)
        tk.Label(win, text="Replace with:", bg=BG, fg=FG).grid(row=1, column=0, padx=5, pady=5, sticky="e")
        rep_e = tk.Entry(win, width=28, bg=MENU_BG, fg=FG, insertbackground=FG, relief="flat")
        ...
        tk.Button(win, text="Replace All", width=14, command=replace_all,
                  bg=STATUS_BG, fg="white", relief="flat", activebackground=MENU_ACTIVE_BG
    ...
    def choose_font(self):
        ...
        tk.Label(win, text="Font:", bg=BG, fg=FG).grid(row=0, column=0, padx=5, pady=5, sticky="w")
        fam_var = tk.StringVar(value=cur.actual("family"))
        tk.OptionMenu(win, fam_var, *families).grid(row=0, column=1, padx=5, pady=5)

        tk.Label(win, text="Size:", bg=BG, fg=FG).grid(row=1, column=0, padx=5, pady=5, sticky="w")
        size_var = tk.IntVar(value=cur.actual("size"))
        tk.Spinbox(win, from_=8, to=72, textvariable=size_var, width=5,
                   bg=MENU_BG, fg=FG, relief="flat").grid(row=1, column=1, padx=5, pady=5, sticky="w")

        def apply_font():
            self.text.config(font=(fam_var.get(), size_var.get()))
            win.destroy()

        tk.Button(win, text="OK", width=10, command=apply_font,
                  bg=STATUS_BG, fg="white", relief="flat").grid(row=2, column=0, columnspan=2, pady=8)
